...
Fl_Window* make_decl_panel() {
  Fl_Window* w;
  { Fl_Window* o = decl_panel = new Fl_Window(290, 334, "declaration");
    w = o;
    ...
    { Fl_Input* o = decl_input = new Fl_Input(10, 40, 270, 180, "Can be any declaration, like \"int x;\", an external symbol like \"extern int\
 ...
 \"/*foo*/\", or typedef like \"typedef char byte;\" or \"using std::list;\".");
    ...
    { Fl_Return_Button* o = decl_panel_ok = new Fl_Return_Button(120, 305, 80, 25, "OK");
      w->hotspot(o);
    }
    { Fl_Button* o = decl_panel_cancel = new Fl_Button(205, 305, 80, 25, "Cancel");
      o->shortcut(0xff1b);
    }
    o->end();
  }
