...
#  if (defined(WIN32) || MSDOS || defined(CRAY)) && !defined(__MINGW32__) && !defined(__MWERKS__)

static double rint(double v) {return floor(v+.5);}
static double copysign(double a, double b) {return b<0 ? -a : a;}
